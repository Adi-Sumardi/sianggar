...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-background text-foreground antialiased" style="background:#f0f6ff">
        <div id="root">
            {{-- Animated splash — shown instantly before React mounts --}}
            <style>
                #splash{display:flex;align-items:center;justify-content:center;min-height:100vh;min-height:100dvh;flex-direction:column;background:linear-gradient(145deg,#f0f6ff 0%,#e0edff 50%,#f0f6ff 100%);overflow:hidden;position:relative}
